...
module.exports=async(req,res)=>{
  if(req.method==="GET"){
    ...
    return res.status(200).json({
      ok:true,
      service:"KitchenaidTech contacto API",
  ...
  try{
    ...
    await transporter.sendMail({
      from:`"KitchenaidTech" <${process.env.SMTP_USER}>`,
      to:process.env.CONTACT_EMAIL||process.env.SMTP_USER,
      replyTo:email,
      subject:"Nueva consulta KitchenaidTech - serviciotecnicoamasadoras.com.es",
      text:`Nueva consulta KitchenaidTech

Nombre: ${nombre}
Teléfono: ${telefono}
Email: ${email}
Producto/modelo: ${equipo}
...
${mensaje}`
    ...
    console.error("KitchenaidTech SMTP error",{
